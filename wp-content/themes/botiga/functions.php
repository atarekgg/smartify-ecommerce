...
function arabic_woocommerce_products_shortcode($atts) {
    ob_start();
    ...
    if ($loop->have_posts()) {
        ...
        echo '<p>' . __('لا توجد منتجات حالياً.', 'woocommerce') . '</p>';
    }
...
add_shortcode('arabic_products', 'arabic_woocommerce_products_shortcode');

//add font
function add_google_fonts() {
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Cairo&display=swap', false );
}
